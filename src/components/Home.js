        ...
        <Row xs={1} md={2} lg={4} className="g-4">
          ...
          <Col>
            <Card>
              ...
              <Card.Body>
                <Link to="/mars-feb2022cohort-fullstackteam/Lynn">
          ...
          <Col>
            ...
            <Card>
              ...
              <Card.Body>
                <Link to="/mars-feb2022cohort-fullstackteam/Heidi">
      ...
      <Container>
        ...
        <Col>
            <Card>
              ...
              <Card.Body>
                <Link to="/mars-feb2022cohort-fullstackteam/Annie">
          ...
          <Col>
            ...
            <Card>
              ...
              />
              <Card.Body>
              <Link to="/mars-feb2022cohort-fullstackteam/NagaPriya">
          ...
          <Col>
            ...
            <Card>
              ...
              />
              <Card.Body>
              <Link to="/mars-feb2022cohort-fullstackteam/Selvapriya">
